...
public class Jogo {
	...
	public static void game(){ // Função que inicializa o jogo.
		...
		int jogadas = 0;
		int alternar_jogador = 1; // Variavel que determina qual jogador está jogando
		...
		while  (jogadas < 9) {
			...
			while (!valido) {
				if (jogador == 'O')
					System.out.printf("Jogador O, informe a posição: ");
				else
					System.out.printf("Jogador X, informe a posição: ");
